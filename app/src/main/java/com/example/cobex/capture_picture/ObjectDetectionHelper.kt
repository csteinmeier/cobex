 ...
 */
class ObjectDetectionHelper private constructor(
    private val tfLite: Interpreter, private val labels: List<String>) {
    ...
    val predictions get() = (0 until OBJECT_COUNT).map { predictions ->
        ObjectPrediction(
